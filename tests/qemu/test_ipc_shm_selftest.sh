...
# Nine processes total must be reaped this boot (Milestone 26/ADR 0026
...
# Milestone 28/ADR 0028 raised it again, 9 to 10; Milestone 30/ADR 0030
# LOWERED it back down, 10 to 9, once the display server itself became
# persistent and moved outside this count) -- see
