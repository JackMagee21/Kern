 ...
 * 0xB8000, reachable from every address space -- see the .c file's
 * comment). Reliable when booted via legacy BIOS/CSM; on a pure UEFI
 * boot with no CSM, 0xB8000 generally isn't a live VGA text buffer
